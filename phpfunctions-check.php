                                ...
                                <div id="f1" class="tab-pane fade active show">
                                    ...
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> exec &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Returns last line of commands output</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> passthru &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Passes commands output directly to the browser</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> system &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Passes commands output directly to the browser and returns last line</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> shell_exec &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Returns commands output</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> popen &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Opens read or write pipe to process of a command</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> proc_open &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Similar to popen() but greater degree of control</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> pcntl_exec &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Executes a program</pre>
                                        </h6>
                                    </div>
                                </div>
                                ...
                                <div id="f2" class="tab-pane fade">
                                    ...
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> assert &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Identical to eval()</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> create_function &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Create an anonymous (lambda-style) function</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> allow_url_fopen &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">This option enables the URL-aware fopen wrappers that enable accessing URL object like files - File inclusion vulnerability</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> allow_url_include &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">This option allows the use of URL-aware fopen wrappers with the following functions: include, include, require, require - File inclusion vulnerability</pre>
                                        </h6>
                                    </div>
                                </div>
                                ...
                                <div id="f3" class="tab-pane fade">
                                    ...
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> expose_php &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Adds your PHP version to the response headers and this could be used for security exploits</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> display_errors &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Shows PHP errors to the client and this could be used for security exploits</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> display_startup_errors &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Shows PHP startup sequence errors to the client and this could be used for security exploits</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> posix_getlogin &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Return login name</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> posix_ttyname &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Determine terminal device name</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> getenv &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Gets the value of an environment variable</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> get_current_user &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Gets the name of the owner of the current PHP script</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> proc_get_status &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Get information about a process opened by proc_open()</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> get_cfg_var &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Gets the value of a PHP configuration option</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> getcwd &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Gets the current working directory</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> getmygid &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Get PHP script owner's GID</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> getmyinode &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Gets the inode of the current script</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> getmypid &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Gets PHP's process ID</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> getmyuid &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Gets PHP script owner's UID</pre>
                                        </h6>
                                    </div>
                                </div>
                                ...
                                <div id="f4" class="tab-pane fade">
                                    ...
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> chgrp &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Changes file group</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> chmod &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Changes file mode</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> chown &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Changes file owner</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> lchgrp &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Changes group ownership of symlink</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> lchown &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Changes user ownership of symlink</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> link &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Create a hard link</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> symlink &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Creates a symbolic link</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> tempnam &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Create file with unique file name</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> touch &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Sets access and modification time of file</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> ftp_get &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Downloads a file from the FTP server</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> ftp_nb_get &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Read from filesystem</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> ftp_put &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Uploads a file to FTP server</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> ftp_nb_put &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Stores a file on FTP server (non-blocking)</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> filegroup &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Gets file group</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> fileinode &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Gets file inode</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> fileowner &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Gets file owner</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> fileperms &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Gets file permissions</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> linkinfo &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Gets information about a link</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> stat &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Gives information about a file</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                    ...
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> lstat &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Gives information about a file or symbolic link</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> readlink &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Returns target of a symbolic link</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> bzopen &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Opens a bzip2 compressed file</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> gzopen &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Open gz-file</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> gzfile &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Read entire gz-file into an array</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> readgzfile &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Output a gz-file</pre>
                                        </h6>
                                    </div>
                                </div>
                                ...
                                <div id="f5" class="tab-pane fade">
                                    ...
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> extract &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Opens the door for register_globals attacks</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> putenv &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Sets value of an environment variable</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> proc_nice &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Change the priority of current process</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> proc_terminate &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Kills a process opened by proc_open</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> proc_close &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Close a process opened by proc_open() and return the exit code of that process</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> apache_child_terminate &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Terminate apache process after request</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> posix_kill &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Send a signal to a process</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> posix_setpgid &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Set process group id for job control</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> posix_setsid &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Make current process a session leader</pre>
                                        </h6>
                                    </div>
                                    <div class="callout callout-default">
                                        <h6><i class="fas fa-code"></i> posix_setuid &nbsp;&nbsp;
                                            ...
                                            ?>
                                            <br /><br />
                                            <pre class="breadcrumb" class="font14">Set UID of current process</pre>
                                        </h6>
                                    </div>
                                </div>
                            </div>
