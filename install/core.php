...
?>
    ...
    <head>
        <title>Forensic Attribution of Cyber Attackers Using Advanced Detection - Installation</title>
            ...
            <div class="card bg-light">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-10">
                        <br />
                        <center>
                            <h3> Forensic Attribution of Cyber Attackers Using Advanced Detection - Installation</h3>
                        </center><br />
                        <div class="jumbotron">
                            <ul class="nav nav-tabs nav-fill">
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($page == 1) {
                                                            echo 'active';
                                                        } ?>"><i class="fas fa-database"></i> Database Settings</a>
                                </li>
                                <li class="nav-item">
